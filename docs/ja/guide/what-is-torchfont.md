...
TorchFont は、**フォントのグリフアウトラインを機械学習向けテンソルとして扱う PyTorch ライブラリ**です。move / line / quadratic / cubic などのパス情報を直接扱いつつ、default sample には小さな bitmap 表現も含めます。
...
- **Rust バックエンド**
  ...
  - default sample ごとに固定 64 x 64 のグレースケール bitmap を生成
