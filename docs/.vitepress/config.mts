          ...
          '/ja/guide/': [
            {
              ...
              items: [
                ...
                { text: 'GlyphDataset の使い方', link: '/ja/guide/dataset' },
                { text: 'グリフデータ形式', link: '/ja/guide/glyph-data-format' },
                { text: 'DataLoader の使い方', link: '/ja/guide/dataloader' },
              ],
            },
          ],
          '/ja/reference/': [
          ...
          '/en/guide/': [
            {
              ...
              items: [
                ...
                { text: 'GlyphDataset Usage', link: '/en/guide/dataset' },
                { text: 'Glyph Data Format', link: '/en/guide/glyph-data-format' },
                { text: 'DataLoader Usage', link: '/en/guide/dataloader' },
              ],
            },
          ],
          '/en/reference/': [
