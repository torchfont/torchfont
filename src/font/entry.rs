...
fn parse_font_tables(
    ...
    let name = Name {
        ...
        font_family_name: one(NameId::FAMILY_NAME),
        font_subfamily_name: one(NameId::SUBFAMILY_NAME),
        unique_font_identifier: one(NameId::UNIQUE_ID),
        full_font_name: one(NameId::FULL_NAME),
        ...
        url_vendor: one(NameId::VENDOR_URL),
        url_designer: one(NameId::DESIGNER_URL),
